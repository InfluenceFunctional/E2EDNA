...
infile="C:/Users\mikem\OneDrive\McGill_Simine\Aptamers\docking\PatchDock_Web\set_1/soln1_utp.pdb"
outfile="C:/Users\mikem\OneDrive\McGill_Simine\Aptamers\docking\PatchDock_Web\set_1/testout.xyz"

# param_file="amoebapro13.prm"
# param_file="amoebabio09.prm"
param_file="C:/Users\mikem\OneDrive\McGill_Simine\Aptamers\docking\PatchDock_Web\set_1/amoebabio18.prm"
        ...
        for atom in residue.atoms:
            ...
            if atom_test.empty == True:
                ...
                try:
                    ...
                    pass#print(residue.name, atom.name, residue.name, test_name)
                atom.mass = int(0)
            else:
                try:
